...
// API setup 
const API_KEY = "AIzaSyC7sd1stgYU6xPYA99csucyjjzJbv11uYg";
...
const generateBotResponse = async (incomingMessageDiv) => {
    ...
    try {
        ...
        // Reset user's file data, removing thinking indicator and scroll chat to 
        userData.file = {};
...
// Initialize emojis picker and handle emoji selection
